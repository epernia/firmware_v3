...
BaseType_t xKeyHit = pdFALSE;
	...
	taskENTER_CRITICAL();
	{
      ...
      /*
		...
		{
			xKeyHit = _kbhit();
		}*/ // FIXME: lo comente porque tiraba warning implicit declaration @Eric
	}
	taskEXIT_CRITICAL();
...
void vApplicationMallocFailedHook( void )
{
	...
	//vAssertCalled( __LINE__, __FILE__ ); // FIXME: lo comente porque tiraba warning implicit declaration @Eric
}
*/ 
// FIXME: lo comente porque tiraba error de multople declaration @Eric
// libs/freertos/source/hooks.c:14: first defined here 
/*-----------------------------------------------------------*/
...
void vApplicationStackOverflowHook( TaskHandle_t pxTask, char *pcTaskName )
{
 ...
 // FIXME: lo comente porque tiraba error de multople declaration @Eric
// libs/freertos/source/hooks.c:8: first defined here 
/*-----------------------------------------------------------*/
