...
int main( void )
{
   ...
   is also set to NULL. */
   xTaskCreate( vTask1, "Task 1", configMINIMAL_STACK_SIZE*2, NULL, tskIDLE_PRIORITY+1, NULL );
...
void vTask1( void *pvParameters )
{
   ...
   for( ;; ) {
      ...
      xTaskCreate( vTask2, "Task 2", configMINIMAL_STACK_SIZE*2, NULL, tskIDLE_PRIORITY+2, &xTask2Handle );
