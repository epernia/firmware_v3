...
int main( void )
{
   ...
   if( xQueue != NULL ) {
      ...
      priority 1. */
      xTaskCreate( vSenderTask, "Sender1", configMINIMAL_STACK_SIZE*2, ( void * ) 100, 1, NULL );
      xTaskCreate( vSenderTask, "Sender2", configMINIMAL_STACK_SIZE*2, ( void * ) 200, 1, NULL );

      /* Create the task that will read from the queue.  The task is created with
      priority 2, so above the priority of the sender tasks. */
      xTaskCreate( vReceiverTask, "Receiver", configMINIMAL_STACK_SIZE*2, NULL, 2, NULL );
