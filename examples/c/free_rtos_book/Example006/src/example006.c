...
int main( void )
{
   ...
   xTaskCreate( vContinuousProcessingTask, "Task 1", configMINIMAL_STACK_SIZE*2, (void*)pcTextForTask1, tskIDLE_PRIORITY+1, NULL );
   xTaskCreate( vContinuousProcessingTask, "Task 2", configMINIMAL_STACK_SIZE*2, (void*)pcTextForTask2, tskIDLE_PRIORITY+1, NULL );
