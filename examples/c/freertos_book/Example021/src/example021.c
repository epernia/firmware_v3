...
int main( void )
{
   ...
   if( xPrintQueue != NULL ) {
      ...
      xTaskCreate( prvPrintTask, "Print1", configMINIMAL_STACK_SIZE*2, ( void * ) 0, 1, NULL );
      xTaskCreate( prvPrintTask, "Print2", configMINIMAL_STACK_SIZE*2, ( void * ) 1, 2, NULL );

      /* Create the gatekeeper task.  This is the only task that is permitted
      to access standard out. */
      xTaskCreate( prvStdioGatekeeperTask, "Gatekeeper", configMINIMAL_STACK_SIZE*2, NULL, 0, NULL );
