...
int main( void )
{
   ...
   xTaskCreate( vTaskFunction, "Task 1", configMINIMAL_STACK_SIZE, (void*)pcTextForTask1, tskIDLE_PRIORITY+1, NULL );

   /* ... and the second task at priority 2.  The priority is the second to
   last parameter. */
   xTaskCreate( vTaskFunction, "Task 2", configMINIMAL_STACK_SIZE, (void*)pcTextForTask2, tskIDLE_PRIORITY+2, NULL );
