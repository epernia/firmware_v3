...
Not available in the freeRTOS version included in the firmware_v2 modules */
#define mainONE_SHOT_TIMER_PERIOD		( ( 3333UL ) / portTICK_RATE_MS )

/* The periods assigned to the one-shot and auto-reload timers respectively. */
/* #define mainAUTO_RELOAD_TIMER_PERIOD	( pdMS_TO_TICKS( 500UL ) )
Not available in the freeRTOS version included in the firmware_v2 modules */
#define mainAUTO_RELOAD_TIMER_PERIOD	( ( 500UL ) / portTICK_RATE_MS )
...
static TickType_t xTimeNow;
	...
	Not available in the freeRTOS version included in the firmware_v2 modules */
	stdioPrintf(UART_USB, "Auto-reload timer callback executing %d\r\n", xTimeNow);
