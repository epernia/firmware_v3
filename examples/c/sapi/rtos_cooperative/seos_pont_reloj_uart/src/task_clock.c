...
static uint8_t Reloj_string[17] = "\r\nRELOJ: HH:MM:SS";
...
void taskClock( void* taskParam )
{
   ...
   Reloj_string[9]  = CharMap[hs/10];
   Reloj_string[10] = CharMap[hs%10];
   Reloj_string[12] = CharMap[min/10];
   Reloj_string[13] = CharMap[min%10];
   Reloj_string[15] = CharMap[seg/10];
   Reloj_string[16] = CharMap[seg%10];
