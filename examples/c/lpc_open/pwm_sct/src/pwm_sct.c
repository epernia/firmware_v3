...
{
   // @Eric Este pin es el LED1 de la EDU-CIAA-NXP
	/* SCT_OUT2 on P2.10 mapped to FUNC1: */
	Chip_SCU_PinMuxSet(0x2, 10, (SCU_MODE_INACT | SCU_MODE_FUNC1));
   
   // @Eric Este pin es el LED3 de la EDU-CIAA-NXP
 ...
 * @return	Nothing
 */
 // @Eric Lo comenté porque está definido en la sAPI
...
int main(void)
{
	...
	while (1) {
		...
		__WFI(); // @Eric dormir el micro hasta la proxima interrupcion (la de systick)
	}
}
